...
<!--    搜索区域-->
    ...
    <el-table
      ...
      <el-table-column label="下载视频">
        <template #default="scope">
          <el-button v-if="scope.row.url" type="primary" @click="download(scope.row.url)">下载</el-button>
        </template>
      </el-table-column>
    ...
    <el-form :model="entity" label-width="120px">
        ...
        <el-form-item label="图片">
          <el-upload action="http://1.15.171.191:8080/files/upload" :on-success="fileSuccessUpload" :file-list="fileList">
            <el-image style="width: 100px" :src="entity.img"></el-image>
<!--            <el-button size="small" type="primary">点击上传</el-button>-->
          </el-upload>
        </el-form-item>
      <el-form-item label="上传视频">
        <el-upload action="http://1.15.171.191:8080/files/upload" :on-success="movieSuccessUpload" :file-list="fileList">
          <el-button size="small" type="primary">点击上传</el-button>
        </el-upload>
      </el-form-item>
...
<!--            <el-button size="small" type="primary">点击上传</el-button>-->
      ...
      <el-form-item label="上传视频">
        <el-upload action="http://localhost:9090/files/upload" :on-success="movieSuccessUpload" :file-list="fileList">
          <el-button size="small" type="primary">点击上传</el-button>
        </el-upload>
      </el-form-item>
