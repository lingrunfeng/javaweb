...
public class MybatisCodeGenerator {
    ...
    private static final String schemaName = "movie";   // 数据库名称，必填
    private static final String[] table = {"notice", ""};   // 必填，第一个是表名，第二个是实体类的名字
    private static final String modelName = "公告管理";   // 必填
...
//        createService(entityName);
    ...
    static void createVue(String entityName, String tableName) throws SQLException {
        ...
        for (TableColumn tableColumn : tableColumns) {
            ...
            StringBuilder formBuilder = formItemBuilder.append(space8 + "<el-form-item label=\"" + tableColumn.getColumnComment() + "\">\n");
