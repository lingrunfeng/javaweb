...
<!--    搜索区域-->
    ...
    <el-table
      ...
      <el-table-column prop="mainActor" label="主演"></el-table-column>
      <el-table-column prop="actors" label="参演演员"></el-table-column>
      <el-table-column prop="date" label="上映日期"></el-table-column>
    ...
    <el-form :model="entity" label-width="120px">
        ...
        <el-form-item label="主演">
          <el-input v-model="entity.mainActor" autocomplete="off" style="width: 80%"></el-input>
        </el-form-item>
        <el-form-item label="参演演员">
          <el-input v-model="entity.actors" autocomplete="off" style="width: 80%"></el-input>
        </el-form-item>
        ...
        <el-form-item label="时长">
          <el-input v-model="entity.duration" autocomplete="off" style="width: 80%"></el-input>
        </el-form-item>
